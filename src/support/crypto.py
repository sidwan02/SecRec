...
def AsymmetricEncrypt(EncryptionKey: AsymmetricEncryptKey, plaintext: bytes) -> bytes:
    ...
    """
    check_type(
        EncryptionKey, AsymmetricEncryptKey, "EncryptionKey", "AsymmetricEncrypt"
    )
...
def AsymmetricDecrypt(DecryptionKey: AsymmetricDecryptKey, ciphertext: bytes) -> bytes:
    ...
    """
    check_type(
        DecryptionKey, AsymmetricDecryptKey, "DecryptionKey", "AsymmetricDecrypt"
    )
...
def SignatureVerify(
    VerifyKey: SignatureVerifyKey, data: bytes, signature: bytes
) -> bool:
    """
